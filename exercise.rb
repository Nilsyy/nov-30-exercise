...
start_date = Date.new(2018, 11,05)

wdi_august = Cohort.new(start_date)

puts wdi_august.coffee_code_days

new_date = Date.new(2018,12,25)

puts wdi_august.coffee_code_day?(new_date)

puts wdi_august.weeks_of_cohort
